...
public class IFingerPresenter implements Handler.Callback, FingerPresenter.Model<String, Boolean> {
    ...
    /***
     * registramos el Broadcast para recibir informacion de sensor de huellas
     */
    ...
    //TODO esta interfaz realiza la escucha del sensor de huellas, "status"
    private SpassFingerprint.IdentifyListener mIdentifyListener = new SpassFingerprint.IdentifyListener() {
        ...
        public void onFinished(int eventStatus) {
            ...
            if (eventStatus == SpassFingerprint.STATUS_AUTHENTIFICATION_SUCCESS) {
                ...
                Toast.makeText(mContext.getActivity(), "Huella digital correcta", Toast.LENGTH_SHORT).show();
                //TODO se carga el resultado de la huella y notifica al fragmento del resultado
                ...
                Log.d("","La huella no coincide con la registrada en el sistema");
                needRetryIdentify = true;
            }
    ...
    public void putModel(String o) {
        //TODO Si fue ok, entonces carga getFirgerResult un valor booleano
        //para pasarle informacion al fragmento que lo implemento
    ...
    public void getModel(Boolean o) {
        //TODO Este es el nombre del metodo que se sobrecarga en el fragmento
